package screens
{
	...
	public class Welcome extends BaseScreen
	{
	    ...
	    {
			//this.dispatchEvent(new NavigationEvent(NavigationEvent.CHANGE_SCREEN, {id: "play"}, true)); <--------------Se cambia por el patron state
			
			//Crea un nuevo estado, se le envia el contexto del juego para que maneje el cambio de las pantallas
		...
		private function onSoundButtonClick(event:Event = null):void
		{
			if (Sounds.muted)
			{
				...
				else if (this.visible) Sounds.sndBgGame.play(0, 999);
